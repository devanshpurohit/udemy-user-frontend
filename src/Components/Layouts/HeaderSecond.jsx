...
import { faArrowRightToBracket, faBell, faBorderAll, faCheck, faChevronDown, faChevronUp, faClose, faEnvelope, faEye, faKitMedical, faLocationCrosshairs, faLocationDot, faPhone, faSearch, faTimes, faUser } from "@fortawesome/free-solid-svg-icons";
                    ...
                    >
                        ...
                        <ul className="navbar-nav mx-auto mb-2 navbar-menu-list">
                            ...
                            >
                                ...
                                <ul className={`dropdown-menu  tble-action-menu nw-dashboard admin-dropdown-card p-0 ${catOpen ? "show" : ""}`}>
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-2">
                            {user? (
                                ...
                                <>
                                    <div>
                                        <a href="javascript:void(0)" className="nw-custom-btn nw-bell-btn"> <FaCartShopping />
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="admn-icon me-2">
                                                <img 
                                                    src={user?.profileImage || "/user_01.jpg"} 
                                                    alt="Profile" 
                                        ...
                                        <ul className={`dropdown-menu dropdown-menu-end user-dropdown sallr-drop-box  tble-action-menu admin-dropdown-card p-0 ${userDropdownOpen ? "show" : ""}`}
                                            style={{ 
                                        ...
                                        >
                                            <li className="prescription-item">
                                                <NavLink to="/my-account" className="dropdown-item prescription-nav ">
                                                    My Account
                                                </NavLink>
                                            </li>
                                            <li className="prescription-item">
                                                <NavLink to="/my-dashboard" className="dropdown-item prescription-nav ">
                                                    My Dashboard
                                                </NavLink>
                                            </li>
                                            <li className="prescription-item">
                                                <NavLink to="/my-wishlist" className="dropdown-item prescription-nav ">
                                                    Wishlist
                                                </NavLink>
                                            </li>
                                            <li className="prescription-item">
                                               <button 
  className="dropdown-item prescription-nav w-100 text-start border-0 bg-transparent"
  onClick={(e) => {
    e.preventDefault();
    console.log("🚪 Logout clicked");
    handleLogout();
                                                        ...
                                                        <div className='row'>
                                                            ...
                                                            <div className="mt-3">
                                                                ...
                                                                <div className="my-2 text-center">
                                                                    ...
                                                                    <a href="javascript:void(0)" className="card-back-btn" data-bs-toggle="modal" data-bs-target="#htmlForgotPasswordModal">Back</a>
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="logout-bx text-center" >
                                        ...
                                        <div className="d-flex align-items-center gap-3 justify-content-center mt-3">
                                            ...
                                            <button className="thm-lg-dg-btn" data-bs-dismiss="modal" aria-label="Close">Logout</button>
